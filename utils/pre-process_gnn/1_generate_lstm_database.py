...
base_path = f"../../input/e-ck+_graphs_30fps/"

# Ruta donde se almacenarán los resultados
output_path = f"../../input/e-ck+_graphs-lstm_30fps/"
...
for partition in os.listdir(base_path):
    ...
    for class_id in os.listdir(partition_path):
        ...
        for subject in os.listdir(class_path):
            ...
            frames = sorted([f for f in os.listdir(subject_path) if f.endswith(".pt")])
            ...
            for i in range(len(frames) - seq_len + 1):
                ...
                for j in range(seq_len):
                    ...
                    dst_frame_name = f"{subject_name}_{seq_id}_frame_{frame_num}.pt"
